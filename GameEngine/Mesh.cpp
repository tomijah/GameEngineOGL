...
void Mesh::Draw(ShaderBase *shader, bool simpl)
{
	...
	shader->SetInteger("material.reflectEnv", this->material.reflect);
	...
	glDrawElements(simpl ? GL_LINE_STRIP : GL_TRIANGLES, this->indices.size(), GL_UNSIGNED_INT, 0);
	glBindVertexArray(0);
}
